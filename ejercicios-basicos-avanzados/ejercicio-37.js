...
// Creamos el array vacío para almacenar las categorías finales
const categorias = [];

//  Primer bucle for...of: Recorremos cada película
for (const movie of movies) {
  
  //  Segundo bucle for...of: Recorremos el array de categorías de ESA película
  for (const category of movie.categories) {
    
    // Comprobamos si la categoría ya existe en nuestro array 'categorias'
    // El símbolo "!" significa "si NO está incluida..."
