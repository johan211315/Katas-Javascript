...
// Iniciamos el bucle for...of para recorrer las canciones
for (const song of songs) {
  
  // Comprobamos las dos condiciones con el operador &&
  if (song.genre === 'Rock' && song.duration > 5.00) {
    
    // Si cumple ambas, la añadimos a la playlist
    rockPlaylist.push(song);
  }
}

console.log("Tu Playlist de Rock (> 5 min):", rockPlaylist);